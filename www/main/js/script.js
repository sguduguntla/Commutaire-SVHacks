...
$("#search").click(function(e) {
    ...
    if (city != "" && state != "" && numBeds != "" && numBaths != "" && priceRange != "") {
        ...
        function error() {
            alert("Unable to load houses on sale. Please disable your browser security to continue. Please RE-OPEN Google Chrome without security through this terminal command: On a Mac (OSX)- 'open -a Google\ Chrome --args --disable-web-security' | On Linux-  'google-chrome --disable-web-security'");
        }
...
function showProfileHTML() {
    ...
    profileHtml += '<img src="../../images/commutaire-logo.png" width="150" height="150" />';
